...
- Initial implementation, built against `DESIGN.md`.
...
- `scripts/no-provider-literals.mjs` — the consumer-compatibility gate, run over `src/` and `dist/`,
  with a negative control proving it goes red on a planted token.
